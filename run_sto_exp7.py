...
from src.noise_coefficients import NON_SOLENOIDAL_NEW

#load global and lokal configs
from configs import local_implEulerExp3 as cf
from configs import global_implicitEuler as gcf
...
def generate() -> None:
    ...
    ### noise coefficient
    noise_coefficients = NON_SOLENOIDAL_NEW(cf.TRUNCATION_INDEX_NOISE,space_disc.mesh,space_disc.velocity_space)
