...
from local_src.algorithm import Chorin_splitting_with_pressure_correctionINFSUP
from local_src.potential import noiseCoefficient, initialCondition, bodyforce1, bodyforce2

#load global and lokal configs
from configs import cfs_potential_s32 as cf
...
def generate_one(time_disc: TimeDiscretisation,
    ...
    ref_to_time_to_preErrorSTO = dict()
    ref_to_time_to_preErrorDET = dict()
    for level in time_disc.refinement_levels:
        ...
        (ref_to_time_to_velocity[level],
         ...
         ref_to_time_to_preError[level],
         ref_to_time_to_pressureSTO[level],
         ref_to_time_to_pressureDET[level],
         ref_to_time_to_preErrorSTO[level],
         ref_to_time_to_preErrorDET[level])  = algorithm(
            ...
            bodyforce1=bodyforce1,
            bodyforce2=bodyforce2,
    ...
    return (ref_to_noise_increments,
            ...
            ref_to_time_to_preErrorSTO,
            ref_to_time_to_preErrorDET)
...
def generate() -> None:
    ...
    force1 = bodyforce1(space_disc.mesh,space_disc.velocity_space)
    force2 = bodyforce2(space_disc.mesh,space_disc.velocity_space)
    ...
    if gcf.TIME_CONVERGENCE:
        ...
        stability_check_preErrorSTO = ProcessManager([
            StabilityCheck(time_disc.ref_to_time_stepsize,"error_L2_L2_pressureSTO",l2_X_norm,l2_space),
            StabilityCheck(time_disc.ref_to_time_stepsize,"error_H-1_L2_pressureSTO",h_minus1_X_norm,l2_space)
        ])
        stability_check_preErrorDET = ProcessManager([
            StabilityCheck(time_disc.ref_to_time_stepsize,"error_L2_L2_pressureDET",l2_X_norm,l2_space),
            StabilityCheck(time_disc.ref_to_time_stepsize,"error_H-1_L2_pressureDET",h_minus1_X_norm,l2_space)
        ])
    ...
    if gcf.STATISTICS_CHECK:
        ...
        statistics_preErrorSTO = StatisticsObject("preErrorSTO",time_disc.ref_to_time_grid,space_disc.pressure_space)
        statistics_preErrorDET = StatisticsObject("preErrorDET",time_disc.ref_to_time_grid,space_disc.pressure_space)
    ...
    for k in new_seeds:
        ...
        (ref_to_noise_increments, 
         ...
         ref_to_time_to_pressureDET,
         ref_to_time_to_preErrorSTO,
         ref_to_time_to_preErrorDET) = generate_one(time_disc=time_disc,
                                                           space_disc=space_disc,
                                                           noise_coefficient=noise_coefficient,
                                                           initial_velocity=initial_velocity,
                                                           bodyforce1=force1,
                                                           bodyforce2=force2,
                                                           algorithm=Chorin_splitting_with_pressure_correctionINFSUP,
        ...
        if gcf.TIME_CONVERGENCE:
            ...
            stability_check_preErrorSTO.update(ref_to_time_to_preErrorSTO)
            stability_check_preErrorDET.update(ref_to_time_to_preErrorDET)
        ...
        if gcf.STATISTICS_CHECK:
            ...
            statistics_preErrorSTO.update(ref_to_time_to_preErrorSTO)
            statistics_preErrorDET.update(ref_to_time_to_preErrorDET)
    ...
    if gcf.TIME_CONVERGENCE:
        ...
        logging.info(stability_check_preErrorSTO)
        logging.info(stability_check_preErrorDET)
        stability_check_preErrorSTO.save(cf.TIME_DIRECTORYNAME)
        stability_check_preErrorDET.save(cf.TIME_DIRECTORYNAME)
    ...
    if gcf.STATISTICS_CHECK:
        ...
        statistics_preErrorSTO.save(cf.VTK_DIRECTORY + "/" + cf.STATISTICS_DIRECTORYNAME)
        statistics_preErrorDET.save(cf.VTK_DIRECTORY + "/" + cf.STATISTICS_DIRECTORYNAME)
