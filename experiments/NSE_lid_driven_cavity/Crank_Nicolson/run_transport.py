...
from local_src.algorithm import lid_driven_cavity_solver_transport

#load global and lokal configs
from configs import cfs_local_transport as cf
    ...
    for k in new_seeds:
        ...
        (ref_to_noise_increments, 
         ...
         ref_to_time_to_pressure_midpoints) = generate_one(time_disc=time_disc,
                                                           ...
                                                           algorithm=lid_driven_cavity_solver_transport,
